...
mod exception_lexer_tests {
    ...
    fn test_try_keyword() {
        ...
        assert_eq!(token, Token::Keyword("try".to_string()));
    ...
    fn test_catch_keyword() {
        ...
        let token = lexer.next_token().unwrap();
        assert_eq!(token, Token::Keyword("catch".to_string()));
    ...
    fn test_finally_keyword() {
        ...
        let token = lexer.next_token().unwrap();
        assert_eq!(token, Token::Keyword("finally".to_string()));
    ...
    fn test_throw_keyword() {
        ...
        let token = lexer.next_token().unwrap();
        assert_eq!(token, Token::Keyword("throw".to_string()));
    ...
    fn test_try_catch_block_structure() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Keyword("try".to_string()));
        assert_eq!(lexer.next_token().unwrap(), Token::LeftBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::RightBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::Keyword("catch".to_string()));
    ...
    fn test_try_catch_finally_structure() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::LeftBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::RightBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::Keyword("finally".to_string()));
        assert_eq!(lexer.next_token().unwrap(), Token::LeftBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::RightBrace);
        assert_eq!(lexer.next_token().unwrap(), Token::Eof);
    }
    ...
    fn test_throw_statement() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Keyword("throw".to_string()));
        assert_eq!(lexer.next_token().unwrap(), Token::Identifier("error".to_string()));
