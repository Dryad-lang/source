...
mod lexer_tests {
    ...
    fn test_tokenize_negative_number() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Operator("-".to_string()));
    ...
    fn test_unterminated_string_error() {
        ...
        match result.unwrap_err() {
            DryadError::Lexer(1002, _) => {}, // E1002 - Unterminated String
    ...
    fn test_tokenize_identifier() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Identifier("variable_name".to_string()));
    }
    ...
    fn test_tokenize_keywords() {
        ...
        for keyword in &keywords {
            ...
            assert_eq!(lexer.next_token().unwrap(), Token::Keyword(keyword.to_string()));
        }
    }
    ...
    fn test_tokenize_null() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Literal("null".to_string()));
    }
    ...
    fn test_skip_line_comment() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Number(42.0));
        assert_eq!(lexer.next_token().unwrap(), Token::Number(24.0));
    ...
    fn test_unterminated_block_comment_error() {
        ...
        assert!(result.is_err());
        match result.unwrap_err() {
            DryadError::Lexer(1003, _) => {}, // E1003 - Unterminated Comment
    ...
    fn test_unexpected_character_error() {
        ...
        assert!(result.is_err());
        match result.unwrap_err() {
            DryadError::Lexer(1001, _) => {}, // E1001 - Unexpected Character
    ...
    fn test_invalid_escape_sequence_error() {
        ...
        assert!(result.is_err());
        match result.unwrap_err() {
            DryadError::Lexer(1005, _) => {}, // E1005 - Invalid Escape Sequence
    ...
    fn test_large_number() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Number(123456789.987654321));
    }
}
