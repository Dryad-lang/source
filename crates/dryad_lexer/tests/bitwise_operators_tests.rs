...
fn test_tokenize_bitwise_and_operator() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Number(12.0)); // 0b1100 = 12
    assert_eq!(lexer.next_token().unwrap(), Token::Operator("&".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(10.0)); // 0b1010 = 10
    assert_eq!(lexer.next_token().unwrap(), Token::Eof);
}
...
fn test_tokenize_symmetric_left_shift_operator() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Number(5.0)); // 0b0101 = 5
    assert_eq!(lexer.next_token().unwrap(), Token::Operator("<<<".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(1.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Eof);
}
...
fn test_exact_syntax_md_example() {
    ...
    // Teste bitwise AND
    let mut lexer = Lexer::new("0b1100 & 0b1010");
    assert_eq!(lexer.next_token().unwrap(), Token::Number(12.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Operator("&".to_string()));
...
fn test_complex_bitwise_expression() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Identifier("result".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol('='));
    assert_eq!(lexer.next_token().unwrap(), Token::Identifier("a".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Operator("<<".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(2.0));
