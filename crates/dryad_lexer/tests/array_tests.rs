...
fn test_array_access() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Identifier("arr".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol('['));
...
fn test_tuple_literal() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Number(1.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol(','));
    assert_eq!(lexer.next_token().unwrap(), Token::String("dois".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol(','));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(3.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol(')'));
    assert_eq!(lexer.next_token().unwrap(), Token::Eof);
...
fn test_tuple_access() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Identifier("tupla".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol('.'));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(1.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Eof);
}
...
fn test_matrix_access() {
    ...
    assert_eq!(lexer.next_token().unwrap(), Token::Identifier("matriz".to_string()));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol('['));
    assert_eq!(lexer.next_token().unwrap(), Token::Number(1.0));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol(']'));
    assert_eq!(lexer.next_token().unwrap(), Token::Symbol('['));
