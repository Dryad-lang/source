// crates/dryad_runtime/tests/integration_foreach_complete.rs
...
#[test]
fn test_foreach_with_break_continue() {
    let code = r#"
        let sum = 0;
...
#[test]
fn test_foreach_tuple_mixed_types() {
    let code = r#"
        let count = 0;
...
#[test]
fn test_foreach_empty_collections() {
    let code = r#"
        let count = 0;
